...
import (
	...
	"github.com/lzyzsd/go-gin-blog/pkg/export"
	"github.com/lzyzsd/go-gin-blog/pkg/file"
	"github.com/lzyzsd/go-gin-blog/pkg/gredis"
	"github.com/lzyzsd/go-gin-blog/pkg/logging"
	"github.com/lzyzsd/go-gin-blog/service/cache_service"
)
...
func (t *Tag) Export() (string, error) {
	...
	for _, v := range tags {
		values := []string{
			...
			v.Name,
			v.CreatedBy,
			strconv.FormatInt(v.CreatedOn, 10),
			v.ModifiedBy,
			strconv.FormatInt(v.ModifiedOn, 10),
		}
